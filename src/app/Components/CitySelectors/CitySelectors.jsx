import styles from "./CitiesSelectors.module.css";
...
export const CitySelectors = () => {
    ...
    const handleChange = (chosenCity) =>{
        passCity(citiesData.find(city => city.name === chosenCity))
    }
    ...
    return (
        <div>
            ...
            <form onChange={(event) => handleChange(event.target.value)} className={styles.formContainer}>
                <select name="cities" id="citiesSelect" className={styles.select}>
